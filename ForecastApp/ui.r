     ...
     fluidRow( 
      column(12, 
        wellPanel(id = "methods", class =  "panel panel-default",
          # h3(tags$b("Note :")), 
          h3(tags$b("Méthodologie"),  tags$span(style = "font-size: 70%; color: black;", "(See", a(href= "https://www.v-dem.net/media/filer_public/b9/b2/b9b2c233-ec45-425d-a397-1cd80dadb63a/v-dem_working_paper_2019_89.pdf", " working paper", target="_blank"), " for more details)")), 
