     ...
     fluidRow( 
      column(12, 
        wellPanel(id = "methods", class =  "panel panel-default",
          ...
          h4(tags$span(style = "font-size: 90%; color: black;", "It is important to note that these forecasts are probabilistic: a high estimated risk does not mean that an ART will occur with certainty; similarly, a low estimated risk does not mean that there is zero chance for an ART to occur.", 
            br(),
            br(),
